 ...
 * - {@link CodeActionCommand#reportFP} stands for reporting false positives, i.e., this allows
 ...
 * - {@link CodeActionCommand#openURL} denotes that the system should open a URL, e.g. for
 * displaying information to the user. See {@link OpenURLCommand}
 *
 * @author Linghui Luo
 */
